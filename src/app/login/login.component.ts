...
<div class="body">
  <div class="login">
    ...
    <div class="card flex justify-center">
      <p-selectbutton [options]="stateOptions" [(ngModel)]="serverType" optionLabel="label" optionValue="value" aria-labelledby="basic" />
    </div>
...
export class LoginComponent implements OnInit {
  ...
  serverType = signal<'LOCAL' | 'PROD'>('LOCAL');

  stateOptions: any[] = [{ label: '로컬', value: 'LOCAL' },{ label: '운영기', value: 'PROD' }];
